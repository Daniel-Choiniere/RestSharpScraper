...
namespace RestSharpScraper
{
    internal static class Program
    {
        private static void Main()
        {
            ...
            Crypto exchangedCrypto = ConsumeAndInitiate(result);
        ...
        {
            const string connection = @"Server=tcp:finance-scraper.database.windows.net,1433;Initial Catalog=CoinMarketCap;Persist Security Info=False;User ID=Dan;Password=iLOVEcareerdevs1;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
        ...
        private static Crypto ConsumeAndInitiate(string result)
        {
